...
import com.heinminlatt.soul_client_app.views.viewHolders.ArtistSoloGroupViewHolder
import com.heinminlatt.soul_client_app.views.viewHolders.SoloArtistViewHolder

class ArtistSoloGroupAdapter : BaseRecyclerAdapter<BaseViewHolder<Int>,Int>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Int> {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_solo_artist_group, parent, false)
        return ArtistSoloGroupViewHolder(view)
    }
}