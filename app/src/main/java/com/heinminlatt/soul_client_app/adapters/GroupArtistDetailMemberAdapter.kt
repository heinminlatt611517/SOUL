...
class GroupArtistDetailMemberAdapter : BaseRecyclerAdapter<BaseViewHolder<Int>,Int>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Int> {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_group_artist_member, parent, false)
        return GroupArtistDetailMemberViewHolder(view)
    }
}