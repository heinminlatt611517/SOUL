...
import com.heinminlatt.soul_client_app.views.viewHolders.AllSoloArtistGroupViewHolder
...
class AllSoloArtistGroupAdapter : BaseRecyclerAdapter<BaseViewHolder<Int>,Int>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Int> {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_all_solo_artist_group, parent, false)
        return AllSoloArtistGroupViewHolder(view)
    }
}