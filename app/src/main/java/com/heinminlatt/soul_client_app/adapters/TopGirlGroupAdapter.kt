...
import com.heinminlatt.soul_client_app.views.viewHolders.TopGirlGroupViewHolder

class TopGirlGroupAdapter : BaseRecyclerAdapter<BaseViewHolder<Int>,Int>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Int> {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_top_girl_group, parent, false)
        return TopGirlGroupViewHolder(view)
    }
}