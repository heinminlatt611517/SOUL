...
import com.heinminlatt.soul_client_app.views.viewHolders.TopSoloArtistGroupViewHolder

class TopSoloArtistGroupAdapter : BaseRecyclerAdapter<BaseViewHolder<Int>,Int>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Int> {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_top_solo_artist_group, parent, false)
        return TopSoloArtistGroupViewHolder(view)
    }
}